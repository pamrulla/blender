...
DefNode( CompositorNode, CMP_NODE_MASK_BOX,       def_cmp_boxmask,        "BOXMASK",        BoxMask,          "Box Mask 5",          ""              )
DefNode(CompositorNode,  CMP_NODE_EFFECT_LIGHTNING,      def_cmp_lightningeffect,      "LIGHTNINGEFFECT", LightningEffect,         "Lightning Effect",         ""              )
